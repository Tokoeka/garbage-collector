...
import { BarfTurnQuests, PostQuest, runGarboQuests, SetupEmbezzlerQuest } from "./tasks";
...
export function main(argString = ""): void {
  ...
  try {
    ...
    setAutoAttack(0);
    setCombatFlags({ flag: "aaBossFlag", value: true }, { flag: "bothcombatinterf", value: false });
